...
public class NewEmailCreationTest extends BaseUITest {
    ...
    String login = "test@ui.gmail.com"; //not valid
    ...
    public void newEmailCreationTest() {
        //- Login to mail.ui.google.com with existing account using stackoverflow.com
        driver.get(url);
        driver.findElement(By.cssSelector("a.login-link.s-btn.s-btn__filled.py8.js-gps-track")).click();
        driver.findElement(By.xpath("//button[@data-provider='ui.google']")).click();
        //ui.gmail login
